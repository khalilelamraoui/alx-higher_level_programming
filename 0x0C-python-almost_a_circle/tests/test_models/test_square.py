...
class TestSquare(unittest.TestCase):
    ...
    def test_6(self):
        ...
        s0_dictionary = s0.to_dictionary()
        s1 = Square(1, 1)
        s1.update(**s0_dictionary)
        self.assertEqual(s0.__str__(), "[Square] (1) 0/0 - 1")
        self.assertEqual(s1.__str__(), "[Square] (1) 0/0 - 1")
        self.assertIsNot(s0, s1)
    ...
    def test_7(self):
        ...
        s1 = Square(1, 1)
        s1.update(**s0_dictionary)
        self.assertEqual(s0.__str__(), "[Square] (1) 1/0 - 1")
        self.assertEqual(s1.__str__(), "[Square] (1) 1/0 - 1")
        self.assertIsNot(s0, s1)
    ...
    def test_8(self):
        ...
        s1 = Square(1, 1, 1)
        s1.update(**s0_dictionary)
        self.assertEqual(s0.__str__(), "[Square] (1) 1/1 - 1")
